...
class _ChatPageState extends State<ChatPage> {
  ...
  void readLocal() {
    ...
    chatProvider.updateFirestoreData(FirestoreConstant.pathUserCollection,
        currentUserId, {FirestoreConstant.chattingWith: widget.peerId});
  }
  ...
  Future<bool> onBackPressed() {
    if (isShowSticker) {
      ...
      chatProvider.updateFirestoreData(FirestoreConstant.pathUserCollection,
          currentUserId, {FirestoreConstant.chattingWith: null});
    }
  ...
  bool isMessageReceived(int index) {
    if ((index > 0 &&
            listMessages[index - 1].get(FirestoreConstant.idFrom) ==
                currentUserId) ||
        index == 0) {
      return true;
    } else {
